export default () => {
  ...
  const _window = window.open(
    "https://osu.ppy.sh/oauth/authorize?response_type=code&redirect_uri=https://localhost:3000osumodhub.herokuapp.com/api/validate&client_id=15113&scope=identify",
    "",
